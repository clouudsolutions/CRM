    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            ...
            <form class="form w-100" novalidate="novalidate"
                id="kt_sign_up_form" data-kt-redirect-url="#" method="POST" action="{{ route('register') }}">
            @csrf
                <!--begin::Heading-->
                ...
                <div class="fv-row mb-8">
                    <!--begin::Email-->
                     <input id="email" type="email" placeholder="Email" name="email" required autocomplete="off" class="form-control bg-transparent" />
                    <!--end::Email-->
                </div>
                <!--begin::Input group-->
                <div class="fv-row mb-8" data-kt-password-meter="true">
                    ...
                    <div class="mb-1">
                        ...
                        <div class="position-relative mb-3">
                            <input class="form-control bg-transparent" id="password" type="password" required placeholder="Password" name="password" autocomplete="off" />
                ...
                <div class="fv-row mb-8">
                    ...
                    <input placeholder="Repeat Password"id="password-confirm" name="password_confirmation" type="password" required autocomplete="off" class="form-control bg-transparent" />
                    <!--end::Repeat Password-->
                </div>
                <!--end::Input group=-->
                <!--begin::Accept-->
